...
def run_epoch(model, loader, criterion, optimizer, device, residual_model=None, geo_scaler=None):
...
def train_split(dataset, train_idx, val_idx, args, fold_name):
    ...
    for epoch in range(1, args.epochs + 1):
        ...
        try:
            ...
            train_m = run_epoch(model, train_loader, criterion, optimizer, device, residual_model)
        finally:
